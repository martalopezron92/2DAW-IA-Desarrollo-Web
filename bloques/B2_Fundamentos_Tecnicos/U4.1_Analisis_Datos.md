...
- **El tiempo**: temperatura, humedad, probabilidad de lluvia
...
**Conclusión**: Vas bien, pero debes reforzar para evitar más 4s.
...
> **Nota**: En este curso nos centraremos en lo **conceptual**. No programaremos modelos predictivos avanzados.
...
> **Nota**: Este es el nivel más avanzado y solo lo veremos de forma conceptual.
...
> **Importante**: Unos datos bien almacenados son fáciles de recuperar y analizar. Datos desorganizados = pesadilla futura.
...
## Tipos de datos en tablas (CSV, Excel, bases de datos)
