# P02 - Debate y ensayo: Ética en sistemas automatizados
...
- **Analizar** casos reales de sesgos algorítmicos y sus consecuencias
- **Argumentar** posiciones éticas de forma fundamentada y estructurada
- **Evaluar** dilemas morales en el desarrollo de sistemas automatizados
- **Reflexionar** críticamente sobre la responsabilidad en IA
- **Proponer** soluciones prácticas para problemas éticos identificados
...
**1. Preparación (15 minutos antes del debate)**
- Revisión final de argumentos
...
- Demostración de conocimiento del tema

**Refutación y contra-argumentación (30%)**
- Capacidad de responder a argumentos opuestos
- Identificación de falacias lógicas
- Construcción de contra-argumentos sólidos
...
- **Argumentos principales** (mínimo 5) con evidencia sólida
- **Contra-argumentos anticipados** para refutar posiciones opuestas
- **Casos de estudio** reales que apoyen su posición
- **Datos estadísticos** y estudios académicos relevantes
- **Propuestas concretas** de implementación o regulación
...
**Estructura de argumentos sólidos:**
1. **Premisa**: Afirmación clara y específica
2. **Evidencia**: Datos, estudios o ejemplos que la apoyan
3. **Justificación**: Explicación de por qué la evidencia apoya la premisa
4. **Implicaciones**: Consecuencias de aceptar o rechazar el argumento

**Técnicas de refutación:**
- **Cuestionar la evidencia**: ¿Es relevante, actualizada, suficiente?
- **Identificar falacias lógicas**: Ad hominem, straw man, false dichotomy
...
- **Usa casos reales**: Los ejemplos concretos son más persuasivos
- **Mantén la calma**: Responde a ataques con profesionalismo
...
**P: ¿Qué pasa si mi equipo no puede participar en el debate por enfermedad?**
