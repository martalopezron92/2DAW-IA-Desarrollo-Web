# Planificación del Curso: Inteligencia Artificial aplicada al Desarrollo Web
...
- **Proyectos reales**: Casos de uso del mundo profesional
- **Aprendizaje incremental**: Cada proyecto construye sobre el anterior
- **Colaboración**: Trabajo individual y en equipos pequeños
- **Reflexión**: Análisis crítico de resultados y procesos

### Estructura de sesiones
1. **Microexplicación teórica** (15-20 min)
2. **Práctica guiada** (40-50 min)
3. **Trabajo autónomo** (30-40 min)
4. **Puesta en común** (10-15 min)

### Herramientas de apoyo
- **GitHub Classroom**: Gestión de entregas
- **Jupyter Notebooks**: Desarrollo y documentación
- **Google Colab**: Entorno colaborativo
- **Discord/Teams**: Comunicación y dudas -->
...
- **Prácticas formativas** (30%): P01, P03, P04b, P07, P09
- **Prácticas sumativas** (50%): P02, P04, P05, P06, P08, P10
- **Proyecto final** (20%): P11 + defensa oral
...
#### Primer trimestre
- **Semana 3**: P02 - Reflexión ética
- **Semana 7**: P04 - Mini-laboratorio
- **Semana 11**: P05 - Modelo predictivo

#### Segundo trimestre
- **Semana 13**: P06 - Clustering
- **Semana 18**: P08 - Deep Learning
- **Semana 23**: P10 - Integración web

#### Tercer trimestre
- **Semana 28**: P11 - Proyecto final
- **Semana 29**: Defensa oral -->

<!-- ## 🔄 Adaptaciones y flexibilidad

### Atención a la diversidad
- **Diferentes ritmos**: Actividades opcionales de refuerzo/ampliación
- **Estilos de aprendizaje**: Visual, auditivo, kinestésico
- **Necesidades especiales**: Adaptaciones metodológicas según necesidad

### Modalidades de trabajo
- **Presencial**: Laboratorio con ordenadores
- **Semipresencial**: Combinación presencial/online
- **Online**: Uso de Google Colab y videoconferencias

### Recuperación y mejora
- **Evaluación continua**: Posibilidad de reentrega mejorada
- **Apoyo tutorial**: Sesiones de consulta individual
...
<!-- ### Recursos humanos
- **Profesor principal**: Especialista en IA y desarrollo web
- **Apoyo técnico**: Para configuración de entornos
- **Invitados**: Profesionales del sector (opcional) -->
